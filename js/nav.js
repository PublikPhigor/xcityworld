...
const showSlide1 = () => {
    ...
    const openButton1 = document.querySelector('.open-button-2');
...
const showSlide2 = () => {
    ...
    const openButton2 = document.querySelector('.open-button-3');
...
const showSlide3 = () => {
    ...
    const openButton3 = document.querySelector('.open-button-4');
...
const showSlide4 = () => {
    ...
    const openButton4 = document.querySelector('.open-button-5');
...
const showSlide5 = () => {
    ...
    const openButton5 = document.querySelector('.open-button-6');
...
const showSlide6 = () => {
    ...
    const openButton6 = document.querySelector('.open-button-7');
